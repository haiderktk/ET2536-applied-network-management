...
#echo "$SNMPD_BIN -r -LE warning -C -c $SNMPD_CONFFILE -p $SNMPD_PIDFILE"
...
echo "    snmpget -v 2c -c public -M+. localhost:5555 1.3.6.1.4.1.4171.40.4.0"
echo ""
...
python simple_subagent.py -m $TMPDIR/snmpd-agentx.sock -p $TMPDIR/
